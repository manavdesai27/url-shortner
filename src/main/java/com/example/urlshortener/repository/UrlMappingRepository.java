...
public interface UrlMappingRepository extends JpaRepository<UrlMapping, Long> {
    ...
    @Query("select u.shortCode as shortCode, u.originalUrl as originalUrl, u.clickCount as clickCount, u.createdAt as createdAt, u.expiresAt as expiresAt " +
           "from UrlMapping u where u.user = :user and (:includeExpired = true or u.expiresAt is null or u.expiresAt > CURRENT_TIMESTAMP)")
    Page<UrlMappingSummary> findSummariesByUser(
